...
models = ['SVM', 'DecisionTree', 'SVM-2K']
scores = [svm_acc, dt_acc, svm2k_acc]
...
# models = ['SVM', 'DecisionTree', 'SVM-2K','Simple MKL']
# scores = [svm_acc, dt_acc, svm2k_acc, mkl_acc]

# plt.figure(figsize=(10,8))
# plt.bar(models,scores,color=['#61f2da', '#f26b61', '#f5c895','#c0d9a3'])
# plt.xlabel('Models')
# plt.ylabel('Accuracy Score')
# plt.title('Accuracy Score Comparison')
# plt.ylim(0,1)
